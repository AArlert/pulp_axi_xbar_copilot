...
<!-- Canonical: iverif-workflow/loop/fail/regression_failure.md — pinned snapshot.
     Axioms: recording. Consumer: orch/human when make regress FAILs. -->
...
| 4 | Single case, reproducible | normal triage | Continue in `workflow/fail/assertion_failure.md` from Q1 | same |
