...
// scoreboard/reference model (scoreboard_refmodel.md — kept as its own
// top-level tb/scoreboard_refmodel.sv file per the feature-matrix module
// mapping), env/virtual-sequencer, sequences, tests.
package xbar_tb_pkg;
